...
<html>
 	...
 	<head>
        ...
        <title>Better Half | Magic Matches</title>
	...
	<thead>
		...
		List<UserAccount> current = new ArrayList<UserAccount>();
		
		current = DBUtil.getAllUserAccount();
		boolean found = false;
		for (int index=0; index < current.size(); index++){
			if(user.getPersonalInterests().equalsIgnoreCase(current.get(index).getPersonalInterests()) ){
			found = true;
			
				out.print("<tr>"); 
			out.print("<td>" + current.get(index).getName() + "</td>"); 
			out.print("<td>" + current.get(index).getLastName() +"</td>");
			out.print("<td>" + current.get(index).getGender()+ "</td>");
			out.print("<td>" + current.get(index).getPersonalInterests()+"</td>");
			out.print("<td>" + current.get(index).getProfessionalInterests()+"</td>");
			out.print("<td>" + current.get(index).getEducation()+"</td>");
			if(current.get(index).getGender().equalsIgnoreCase("M") )
